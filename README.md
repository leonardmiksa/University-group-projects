...
Notes:  
> While the system worked perfectly during laboratory simulations on a Siemens S7-1500 PLC, the implementation as designed would be heavily impractical for real-world deployment due to control logic
